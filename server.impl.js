...
// Read admin password from environment for production safety; fall back to the existing default for local/dev convenience.
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || '8763951777';
if(!process.env.ADMIN_PASSWORD){
  console.warn('[SECURITY] ADMIN_PASSWORD is not set as an environment variable. Using built-in default password — change this in production by setting ADMIN_PASSWORD.');
}
